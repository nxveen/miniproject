...
import 'package:miniproject/host1.dart';
    ...
    return Scaffold(
      ...
      Column(children: [
        ...
        Container(
            ...
            child: Center(
              child: TextButton(
                onPressed: () async {await HostRider().startHostRider(start_loc: id,end_loc: id2,user_id: '123');

                result=await HostRider().searchHiker(start_loc_str: id, end_loc_str: id2, user_id: '123');print('hi');
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Host(id: id, id2:id2,result:result)),
                );},
                child: Container(
                    height: h * 0.05,
                    width: w * 0.3,
