...
class Confirm extends StatelessWidget {
  var id='';
  var id2='';
  Confirm({required this.id,required this.id2}
      ) {isScanned4=(id=='4'? true:false);isScanned3=(id=='3'? true:false);isScanned2=(id=='2'? true:false);isScanned1=(id=='1'? true:false);
        _isPressed4=(id2=='4'? true:false);_isPressed3=(id2=='3'? true:false);_isPressed2=(id2=='2'? true:false);_isPressed1=(id2=='1'? true:false);
  }
  @override
                    ...
                    child: Center(
                            child:TextButton(onPressed: () {},
                              child: Container(height: h*0.05,width: w*0.3,
                                  decoration:const BoxDecoration(color: Color.fromRGBO(56, 27, 97, 1),
                                      borderRadius: BorderRadius.all(Radius.circular(20.0))
                                  ),
                                  child: Center(
                                    child: Text('CONFIRM',
